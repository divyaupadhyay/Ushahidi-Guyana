...
$lang = array(
	...
	'settings_dashboard_redirect' => 'If \'Yes\' is selected, then users will be redirected to their dashboard upon logging in. Otherwise, they will be redirected to the index page of the site.',
	...
	'settings_enable_category_filters' => 'This will either enable or disable the category filters on the homepage.',
	'settings_enable_category_filters_showhide' => 'This will either enable or disable the option to show/hide the category filters; it will not enable/disable the category filters themselves.',
	'settings_enable_chronological_filter' => 'This will either enable or disable the chronological filter on the homepage.',
	'settings_enable_filter_search' => 'This will add an enhanced search bar (in most themes) underneath the map that will allow users to filter the markers on the map via a keyword search.',
	'settings_enable_media_filters' => 'This will either enable or disable the media filters on the homepage.',
	'settings_enable_report_notifications' => 'This will add a notification bubble to the reports tab that lets users know when there are new reports. The notification bubble will disappear after the user has viewed the reports tab. NOTE: Turning report notifications off after they have already been on will remove any existing notifications from the database.',
	...
	'settings_show_reporting_options' => 'This will either show or hide the reporting options (the \'How to Report\' section) on the homepage.',
	'settings_show_submit_report_tab' => 'This will either show or hide the \'Submit a Report\' tab. (The \'Submit a Report\' button will still be visible.)',
